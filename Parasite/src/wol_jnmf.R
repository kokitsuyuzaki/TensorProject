...
# Data
Xs <- list(At_logTPM=At_logTPM, Y_At_wol=Y_At_wol,
	Y_Pj_wol=Y_Pj_wol, Pj_logTPM=Pj_logTPM)

# jNMF-type decomposition
params <- new("CoupledMWCAParams",
	# Data-wise setting
	Xs=Xs,
	mask=list(At_logTPM=NULL, Y_At_wol=NULL,
	Y_Pj_wol=NULL, Pj_logTPM=NULL),
	weights=list(At_logTPM=1, Y_At_wol=1,
	Y_Pj_wol=1, Pj_logTPM=1),
	# Common Factor Matrices
	common_model=list(
		At_logTPM=list(I1="A1", I2="A2"),
		Y_At_wol=list(I2="A2", I3="A3"),
		Y_Pj_wol=list(I4="A4", I3="A3"),
	...
	specific_model=list(
		...
		Y_At_wol=list(J3="B3", J4="B4"),
		Y_Pj_wol=list(J5="B5", J6="B6"),
