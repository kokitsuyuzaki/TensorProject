...
load("output/nmf.RData")

# Plot: PC5以降は個体差
png(file="plot/nmf_at.png", width=900, height=700)
pairs(res_nmf_At$V[, seq(5)], pch=16, cex=2,
...
# Plot: PC3以降は個体差
png(file="plot/nmf_pj.png", width=900, height=700)
pairs(res_nmf_Pj$V[, seq(5)], pch=16, cex=2,
