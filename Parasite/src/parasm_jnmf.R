...
# Data
Xs <- list(At_logTPM=At_logTPM, Y_At_parasm=Y_At_parasm,
	Y_Pj_parasm=Y_Pj_parasm, Pj_logTPM=Pj_logTPM)

# jNMF-type decomposition
params <- new("CoupledMWCAParams",
	# Data-wise setting
	Xs=Xs,
	mask=list(At_logTPM=NULL, Y_At_parasm=NULL,
	Y_Pj_parasm=NULL, Pj_logTPM=NULL),
	weights=list(At_logTPM=1, Y_At_parasm=1,
	Y_Pj_parasm=1, Pj_logTPM=1),
	# Common Factor Matrices
	common_model=list(
		At_logTPM=list(I1="A1", I2="A2"),
		Y_At_parasm=list(I2="A2", I3="A3"),
		Y_Pj_parasm=list(I4="A4", I3="A3"),
