...
C_At[10001:10003, 1:10000] <- t(scaled_At_logTPM %*% Y_At_time)
C_At[10004:10005, 1:10000] <- t(scaled_At_logTPM %*% Y_At_wol)
C_At[10006:10007, 1:10000] <- t(scaled_At_logTPM %*% Y_At_parasm)
...
C_Pj[10001:10003, 1:10000] <- t(scaled_Pj_logTPM %*% Y_Pj_time)
C_Pj[10004:10005, 1:10000] <- t(scaled_Pj_logTPM %*% Y_Pj_wol)
C_Pj[10006:10007, 1:10000] <- t(scaled_Pj_logTPM %*% Y_Pj_parasm)
