...
X_RNA = nnTensor::toyModel(model="siNMF_Hard")[[1]]
...
X_GAM = nnTensor::toyModel(model="siNMF_Hard")[[2]]
...
# Output
write.table(X_RNA, "data/toydata3/X_RNA.csv",
    row.names=FALSE, col.names=FALSE,
    quote=FALSE, sep=",")
write.table(X_GAM, "data/toydata3/X_GAM.csv",
    row.names=FALSE, col.names=FALSE,
    quote=FALSE, sep=",")
write.table(X_Epi, "data/toydata3/X_Epi.csv",
    row.names=FALSE, col.names=FALSE,
    quote=FALSE, sep=",")
write.table(W, "data/toydata3/W.csv",
    row.names=FALSE, col.names=FALSE,
    quote=FALSE, sep=",")
write.table(Winv, "data/toydata3/Winv.csv",
    row.names=FALSE, col.names=FALSE,
    quote=FALSE, sep=",")