...
# Download
sce <- DatabaseImmuneCellExpressionData()
...
# Save
write.table(logcpm, "data/scRNAseq/Human_PBMC_4/X_RNA.csv",
	row.names=FALSE, col.names=FALSE, quote=FALSE)
write.table(genenames, "data/scRNAseq/Human_PBMC_4/GeneNames.csv",
	row.names=FALSE, col.names=FALSE, quote=FALSE)
write.table(label, "data/scRNAseq/Human_PBMC_4/Label.csv",
	row.names=FALSE, col.names=FALSE, quote=FALSE)