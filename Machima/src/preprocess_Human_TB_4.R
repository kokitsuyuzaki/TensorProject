...
# Loading
logcpms <- as.matrix(read.csv("data/scRNAseq/Human_PBMC_4/X_RNA.csv",
	header=FALSE))
gene_names <- unlist(read.csv("data/scRNAseq/Human_PBMC_4/GeneNames.csv",
	header=FALSE))
label <- unlist(read.delim("data/scRNAseq/Human_PBMC_4/Label.csv",
	header=FALSE))
